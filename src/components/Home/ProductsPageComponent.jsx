...
export default function ProductsPage() {
  ...
  const filtered = products
    .filter((p) => {
      ...
      const matchCat =
        !selCat ||
        p.service?.category?.slug === selCat ||
        p.service?.category === selCat;
    ...
    .sort((a, b) => {
      ...
      if (sort === "price-desc")
        return (b.priceMonth ?? 0) - (a.priceMonth ?? 0);
  ...
  const activeFilters = [
    selCat,
    showAvail ? t("products.available_only") : "",
  ].filter(Boolean);
            ...
            >
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex-1 min-w-[180px]">
                  <label
                    className="block text-xs font-[Kumbh Sans] font-600 mb-2"
                    style={{ color: "var(--text-muted)" }}
                  >
      ...
      <div className="cyna-container py-10">
        ...
        {loading ? (
          ...
          >
            ...
            />
            <p
              className="font-[Kumbh Sans] font-600"
